...
const fStyles = StyleSheet.create({
  ...
  row: {
    ...
    backgroundColor: 'rgba(26,34,53,0.8)', borderRadius: RADIUS.md, borderWidth: 1,
...
const styles = StyleSheet.create({
  ...
  tabActive: { backgroundColor: 'rgba(26,34,53,0.9)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.07)' },
  ...
  dayCard: { borderRadius: RADIUS.md, padding: SPACING.md, marginBottom: SPACING.sm, borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)', backgroundColor: 'rgba(26,34,53,0.4)' },
  ...
  slotConfig: { marginTop: SPACING.md, paddingTop: SPACING.md, borderTopWidth: 1, borderTopColor: 'rgba(255,255,255,0.05)' },
  ...
  stepperBtn: { width: 38, height: 38, borderRadius: RADIUS.sm, backgroundColor: 'rgba(255,255,255,0.08)', borderWidth: 1, borderColor: COLORS.border, justifyContent: 'center', alignItems: 'center' },
  stepperBtnText: { fontSize: 20, color: COLORS.textPrimary, fontWeight: '700', lineHeight: 24 },
  stepperInput: { flex: 1, height: 38, backgroundColor: 'rgba(26,34,53,0.8)', borderWidth: 1, borderColor: COLORS.border, borderRadius: RADIUS.sm, color: COLORS.textPrimary, fontSize: FONT_SIZES.base, fontWeight: '700' },
