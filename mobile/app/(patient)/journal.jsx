...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: SPACING.lg, paddingTop: 56, paddingBottom: SPACING.md, backgroundColor: 'rgba(19, 25, 41, 0.95)', borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.05)' },
  ...
  searchBar: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(28, 36, 56, 0.6)', borderRadius: RADIUS.md, borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)', marginHorizontal: SPACING.lg, marginTop: SPACING.md, paddingHorizontal: SPACING.md, height: 44 },
  ...
  filterChip: { paddingHorizontal: SPACING.md, paddingVertical: 7, borderRadius: RADIUS.full, borderWidth: 1, borderColor: COLORS.border, backgroundColor: 'rgba(26,34,53,0.8)' },
  filterChipText: { fontSize: FONT_SIZES.xs, color: COLORS.textSecondary, fontWeight: '600' },
  
  list: { padding: SPACING.lg, paddingBottom: 100 },
  card: { backgroundColor: 'rgba(28, 36, 56, 0.6)', borderRadius: RADIUS.lg, marginBottom: SPACING.sm, borderWidth: 1, borderColor: 'rgba(255,255,255,0.06)', overflow: 'hidden' },
  ...
  expanded: { borderTopWidth: 1, borderTopColor: 'rgba(255,255,255,0.06)', padding: SPACING.md, backgroundColor: 'rgba(0,0,0,0.1)' },
  ...
  textBlock: { fontSize: FONT_SIZES.sm, color: COLORS.textSecondary, backgroundColor: 'rgba(255,255,255,0.03)', padding: SPACING.sm, borderRadius: RADIUS.sm, borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)' },
  ...
  actions: { flexDirection: 'row', justifyContent: 'flex-end', gap: SPACING.sm, paddingTop: SPACING.sm, marginTop: SPACING.sm, borderTopWidth: 1, borderTopColor: 'rgba(255,255,255,0.04)' },
  ...
  modalHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: SPACING.lg, borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.05)' },
  ...
  inputField: { backgroundColor: 'rgba(26,34,53,0.8)', borderWidth: 1, borderColor: COLORS.border, borderRadius: RADIUS.md, height: 48, paddingHorizontal: SPACING.md, color: COLORS.textPrimary, fontSize: FONT_SIZES.base },
  row: { flexDirection: 'row' },
  moodRow: { flexDirection: 'row', gap: SPACING.sm },
  moodBtn: { flex: 1, borderWidth: 1, borderColor: COLORS.border, backgroundColor: 'rgba(26,34,53,0.8)', paddingVertical: 10, borderRadius: RADIUS.md, alignItems: 'center' },
  moodBtnText: { color: COLORS.textSecondary, fontSize: 11, fontWeight: '700' },
  painRow: { flexDirection: 'row', gap: SPACING.sm },
  painBtn: { flex: 1, borderWidth: 1, borderColor: COLORS.border, backgroundColor: 'rgba(26,34,53,0.8)', paddingVertical: 10, borderRadius: RADIUS.md, alignItems: 'center' },
  ...
  textArea: { backgroundColor: 'rgba(26,34,53,0.8)', borderWidth: 1, borderColor: COLORS.border, borderRadius: RADIUS.md, padding: SPACING.md, color: COLORS.textPrimary, fontSize: FONT_SIZES.base, minHeight: 80, textAlignVertical: 'top' },
