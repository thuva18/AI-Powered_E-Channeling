...
>>>>>>> Stashed changes
            ...
            <div className="absolute top-0 left-0 right-0 flex items-center justify-between px-10 py-5">
                <div className="flex items-center gap-2.5">
                    ...
                    <span className="font-bold text-slate-800 text-lg tracking-tight">Medicare</span>
                </div>
                <span className="text-xs font-medium text-slate-400 hidden sm:block">E-Channeling System</span>
            </div>
            ...
            <div className="w-full max-w-[440px] animate-fade-up">
                ...
                <p className="text-center text-xs text-slate-400 mt-6">
                    © 2025 Medicare · E-Channeling Platform
                </p>
            </div>
        </div>
    );
